...
export class NotifySlackPeoplePullRequestReviewLogic implements Logic, ScheduleListener, PushListener {
  ...
  async execute(): Promise<void> {
    ...
    const githubUsernames = ['amisskii', 'axel7083', 'benoitf', 'cbr7', 'cdrage', 'danivilla9', 'deboer-tim', 'dgolovin', 'eqqe', 'feloy', 'gastoner', 'jeffmaury', 'jiridostal', 'MarsKubeX', 'nichjones1', 'odockal', 'serbangeorge-m', 'slemeur', 'ScrewTSW', 'SoniaSandler'];
